...
//提交订单
	...
	public List<Map<String, Object>> findMapListByOid(String oid) throws SQLException {
		QueryRunner runner = new QueryRunner(DataSourceUtils.getDataSource());
		String sql = "select i.count,i.subtotal,p.pname,p.shop_price,p.pimage from product p, orderitem i where p.pid=i.pid and i.oid=?";
