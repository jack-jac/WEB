			...
			<div class="col-md-8"
				...
				<form id="myform" class="form-horizontal" style="margin-top: 5px;" action="${pageContext.request.contextPath}/register" method="post">
					<div class="form-group">
						...
						<!-- <label class="error" for="username" style="display: none">用户名不能为空！</label> -->
					</div>
					<div class="form-group">
						...
						<label class="error" for="password" style="display: none">密码不能为空并且要是6-12位</label>
					</div>
					<div class="form-group">
